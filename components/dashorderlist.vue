...
<div>
  <MazCard class="w-full mb-4">
    ...
    <div class="flex lg:flex-row lg:w-48 flex-col w-full gap-2">
      <MazBtn size="lg" color="success" @click="onCheckout">確認選取的訂單</MazBtn>
      <MazBtn size="lg" color="danger" @click="onCheckout">刪除選取的訂單</MazBtn>
    </div>
  </MazCard>
  <div class="overflow-x-auto overflow-y-auto text-zinc-100">
    <MazTable
      ...
      :headers="[
        ...
        { label:'狀態', key: 'checked' },
        { label: '總數', key: 'quantity', align: 'center', width: '2rem'  },
        { label: '價格', key: 'price', width: '2rem' },
        { label:'商品', key: 'text' },
      ]"
      :rows="data"
    >
